...
public class CRUDDao extends DAOClass{
	...
	public Contato buscaContatoId(long idC) throws SQLException {
		...
		try {
			...
			if(respostaSQL.next()) {
				resultado = new Contato(respostaSQL.getLong(1),respostaSQL.getString(2),respostaSQL.getString(3),respostaSQL.getString(4),(Date)(respostaSQL.getDate(6)), respostaSQL.getString(5), respostaSQL.getString(7));
			}else {
	...
	public ArrayList<Contato> listarContatos() throws SQLException {
		...
		while(respostaSQL.next()) {
			...
			tempContato.preencherContato(respostaSQL.getLong(1),respostaSQL.getString(2),respostaSQL.getString(3),respostaSQL.getString(4),dt,respostaSQL.getString(5),respostaSQL.getString(7));
